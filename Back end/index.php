  ...
  <main id="main">
    ...
    <section id="contact" class="contact">
      ...
      <div class="row">    
        ...
        <div class="form col-lg-6 mt-4 mt-lg-0">
          <form action="#contact" method="POST" role="form" class="php-email-form">
              <div class=" form-group">
                <input type="text" name="username" class="form-control" id="name" placeholder="الأسم" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
            ...
            <div class="form-group">
              <textarea class="form-control" name="message" rows="5" data-rule="required"  placeholder="الرسالة"></textarea>
              <div class="validate"></div>
            </div>
